...
Router.prototype.resource = function(route, resource) {
  // TODO: Add route generation
	var db=this.db;
	if(resource.list)this.get(route,function(req,res){resourse.list(req,res,db)});
	if(resource.create)this.post(route,function(req,res){resourse.create(req,res,db)});
	if(resource.read)this.get(route+'/:id',function(req,res){resourse.read(req,res,db)});
